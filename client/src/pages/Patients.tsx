...
export default function Patients() {
  ...
  const [statusFilters, setStatusFilters] = useState<("契約中" | "終了" | "新規")[]>(["契約中", "新規"]);
  ...
  const handleCreatePatient = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await createPatientMutation.mutateAsync({
        ...
        status: (formData.get("status") as "契約中" | "終了" | "新規") || "新規",
      ...
      <div className="space-y-6 animate-fade-in">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">患者情報の閲覧と管理</p>
          </div>
                  ...
                  >
                    ...
                    <td>
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        p.patient.status === "契約中" ? "bg-green-100 text-green-800" :
                        p.patient.status === "終了" ? "bg-gray-100 text-gray-800" :
          ...
          <DialogContent className="max-w-2xl">
            <form onSubmit={handleCreatePatient}>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="nameKana">読み仮名</Label>
                  <Input id="nameKana" name="nameKana" placeholder="カタカナで入力" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select name="status" defaultValue="新規">
                      <SelectTrigger><SelectValue placeholder="選択してください" /></SelectTrigger>
                      <SelectContent>
